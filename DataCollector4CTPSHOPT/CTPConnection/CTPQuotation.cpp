...
//		tagSnapHF.Amount = pQuotationData->Turnover * refNameTable.ContractMult;
	...
	{	///< 更新日期+时间
		...
		QuoCollector::GetCollector()->OnData( 137, (char*)&tagStatus, sizeof(tagStatus), true );
	}

	QuoCollector::GetCollector()->OnData( 139, (char*)&tagSnapLF, sizeof(tagSnapLF), true );
	QuoCollector::GetCollector()->OnData( 140, (char*)&tagSnapHF, sizeof(tagSnapHF), true );
	QuoCollector::GetCollector()->OnData( 141, (char*)&tagSnapBS, sizeof(tagSnapBS), true );
}
